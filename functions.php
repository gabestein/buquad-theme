...
function article_card($id, $class = '') {
  ...
  $post_image = get_the_post_thumbnail($id, 'card', array('style' => 'max-width: 400px; height: auto'));
  if(!$post_image) {
    $post_image = '<img style="max-width: 400px; height: auto;" alt="placeholder image" src="'.get_template_directory_uri().'/assets/images/default-card.png">';
  }
  // render card
  ?>
