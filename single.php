...
<article class="single" id="<?php the_ID(); ?>">
    ...
    <footer>
      <section class="plea">
        ...
        <div class="share-sub">
          <a class="facebook"><i class="fa fa-icon-facebook-sign"></i> Share</a>
          <a class="twitter"><i class="fa fa-icon-twitter"></i> Tweet</a>
          <a class="email"><i class="fa fa-envelope"></i> Email to a Friend</a>
          <a class="support"><i class="fa fa-icon-credit-card"></i> Support</a>
        </div>
      </section>
