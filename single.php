      ...
      <section class="plea">
        ...
        <div class="share-sub">
          <div class="share">
            ...
            <a class="twitter" onclick="twitter_share(e)"  data-via="sleeperave" data-text="<?php echo get_the_excerpt(); ?>" data-url="<?php the_permalink(); ?>"><i class="fa fa-twitter"></i> Tweet</a>
