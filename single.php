...
<article class="single" id="<?php the_ID(); ?>">
    ...
    <footer>
      <section class="plea">
        <p class="comments"><strong>Thoughts, comments or questions about this story?</strong> Send me a note here, or via email at <em>edstein2 at gmail dot com</em>. I publish my favorite comments weekly on my blog.</p>
