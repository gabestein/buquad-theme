...
<article class="single" id="<?php the_ID(); ?>">
    ...
    <footer>
      <section class="plea">
        <p class="comments"><strong>Thoughts, comments or questions about this story?</strong> Send me a note <a href="/feedback">here</a>, or via email at <a href="mailto:ed@sleeperave.com?subject=Comment on <?php echo $the_title; ?>">ed@sleeperave.com</a>. I publish my favorite comments weekly on my blog.</p>
