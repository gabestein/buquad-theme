      ...
      <section class="plea">
        ...
        <div class="share-sub">
          <div class="share">
            ...
            <a class="email" target="_blank" href="mailto:?subject=Sleeper Ave.: <?php the_title(); ?>&body=Hi!%0D%0A%0D%0AI thought you might enjoy this Sleeper Ave. comic by Ed Stein.%0D%0A%0D%0A<?php the_title(); ?>%0D%0A<?php echo get_the_excerpt(); ?>%0D%0A%0D%0A<?php the_permalink(); ?>"><i class="fa fa-envelope"></i> Email a Friend</a>
